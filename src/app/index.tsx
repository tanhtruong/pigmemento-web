...
export const App = () => {
  return (
    <AppProvider>
      <AppRouter />
      <div className="fixed right-10 bottom-0 m-8 p-3 text-xs font-mono text-white h-6 w-6 rounded-full flex items-center justify-center bg-gray-700 sm:bg-pink-500 md:bg-orange-500 lg:bg-green-500 xl:bg-blue-500">
